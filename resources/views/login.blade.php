...
<form class="p-5 mt-3  was-validated log">
<h1 class="text-white font-weight-bolder text-center p-3">Login</h1>
<div class="form-group">
 <lable for="UserName" class="text-white font-weight-bolder">UserName</lable>
 <input type="text" palceholder="username" name="uname" class="form-control" required>
 <div class="valid-feedback">Valid</div>
 <div class="invalid-feedback text-warning">Please enter a correct username</div>
</div>
<div class="form-group">
 <lable for="password" class="text-white font-weight-bolder">Password</lable>
 <input type="text" palceholder="password" name="pass" class="form-control" required>
 <div class="valid-feedback">Valid</div>
 <div class="invalid-feedback text-warning">Please enter a correct password</div>
</div>
