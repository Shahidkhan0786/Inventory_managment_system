...
<body >
    ...
    <h3 class= "font-weight-bolder  bg-primary text-uppercase text-white"><i>Shahid Khan</i></h3>
    <h3 class= "font-weight-bolder  bg-primary text-uppercase text-white text-right"><mark><i>Time : 10:59 Am</i></mark></h3>
    </div>
